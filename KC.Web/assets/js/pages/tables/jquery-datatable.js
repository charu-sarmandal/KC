...
$(document).ready(function() {
  ...
  $('#tblEmployee thead tr').clone(true).appendTo( '#tblEmployee thead' );
     
	// $('#tblEmployee tfoot th').each( function (i) {
        // var title = $('#tblEmployee thead th').eq( $(this).index() ).text();
        // $(this).html( '<input type="text" placeholder="Search '+title+'" data-index="'+i+'" />' );
    // } );
	
	$('#tblEmployee thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
        ...
        $( 'input', this ).on( 'keyup change', function () {
			...
			$(this).html( '<label for="Action"></label>' );
		}
    } );
    ...
    events: function() {
        ...
        return this.$table.on("click", "button.button-save", function(e) {
            ...
            swal({
                ...
                swal("Deleted!", "Your selected record has been deleted.", "success");
            });
